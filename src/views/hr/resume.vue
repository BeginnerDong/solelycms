    ...
    <div style="height: 90%;">
      ...
      >
        ...
        <template v-slot:job="job">
         ...
         <template v-slot:passage_array="passage_array">
          {{passage_array.data.passage_array[0]}}--{{passage_array.data.passage_array[1]}}--{{passage_array.data.passage_array[2]}}
        </template>
...
<script>
  import resumeJs from './resume.js'
  export default resumeJs
</script>
<style>
