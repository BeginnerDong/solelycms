      ...
      >
        ...
        <template v-slot:start_time="start_time">
          ...
          <div>
            ...
            >
              {{self.$$formatDate( new Date(parseInt(start_time.data.end_time)) ,'yyyy-MM-dd hh:mm')}}
            </span>
            <span
            v-else-if="parseInt(start_time.data.end_time)<new Date(new Date().toLocaleDateString()).getTime()"
