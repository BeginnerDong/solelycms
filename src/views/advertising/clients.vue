    ...
    <div style="height: 90%;">
      ...
      >
        <template v-slot:expand="expand">
            ...
            <div style="width:30%;height: auto;display: inline-block;vertical-align: top;padding: 8px 0;">
              <span style="font-weight: bold;">沟通记录：</span>
              <br>
              <div v-for="(item,index) in expand.data.Conversation" :key="index">
                <span style="font-weight: bold;">记录：</span>
                {{item.description}}
            ...
            <div style="width:30%;height: auto;display: inline-block;vertical-align: top;padding: 8px 0;">
              ...
              <div style="margin-bottom: 5px;" v-for="(item,index) in expand.data.file" :key="index">
                 <li>文件名:&nbsp;<a :href="item.url" target="view_window">{{item.title}}</a></li>
              </div>
            </div>
...
<script>
  import clientsJs from './clients.js'
  export default clientsJs
</script>
<style>
